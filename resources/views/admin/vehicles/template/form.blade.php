<form action="{{ isset($vehicle) ? route('admin.vehicles.update', $vehicle->id) : route('admin.vehicles.store') }}"
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="load_capacity" id="load_capacity" class="form-control" placeholder="0.00"
                       value="{{ isset($vehicle) ? $vehicle->load_capacity : '' }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label for="fuel_capacity">Cap. Comb. (L)</label>
                <input type="number" step="0.01" name="fuel_capacity" id="fuel_capacity" class="form-control" placeholder="0.00"
                       value="{{ isset($vehicle) ? $vehicle->fuel_capacity : '' }}">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" name="passenger_capacity" id="passenger_capacity" class="form-control" placeholder="0"
                       value="{{ isset($vehicle) ? $vehicle->passenger_capacity : '' }}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="compaction_capacity" id="compaction_capacity" class="form-control" placeholder="0.00"
    ...
    <div class="form-group">
        ...
        <textarea name="description" id="description" class="form-control" rows="2" placeholder="Detalles técnicos, estado general, etc.">{{ isset($vehicle) ? $vehicle->description : '' }}</textarea>
    </div>
                ...
                @foreach($vehicle->images as $image)
                    <div class="col-md-3 mb-2">
                        <div class="card shadow-sm">
                            <img src="{{ asset('storage/' . $image->path) }}" class="card-img-top" style="height: 100px; object-fit: cover;">
                        </div>
                    </div>
                @endforeach
            </div>
