...
<div class="form-group">
    ...
    <select id="vehicle_id" name="vehicle_id" class="form-control" required>
        ...
        @foreach ($vehicles as $vehicle)
            <option value="{{ $vehicle->id }}" data-capacity="{{ $vehicle->passenger_capacity }}"
                @isset($group)
...
<div class="form-group">
    ...
    <label>
        Días de trabajo <span class="text-danger">*</span>
    </label>
        ...
        @foreach ($dias as $dia)
            <div class="col-md-4">
                ...
                <div class="form-check">
                    ...
                    <input type="checkbox" class="form-check-input" name="workdays[]" value="{{ $dia }}"
                        id="dia_{{ $loop->index }}" {{ in_array($dia, $diasSeleccionados) ? 'checked' : '' }}>
...
@php
    ...
    if (isset($group)) {
        $selectedHelpersJson = $group->helpers->pluck('personnel_id')->values()->toArray();
    }
    ...
    function generarCamposAyudantes() {
        ...
        for (let i = 0; i < cantidadAyudantes; i++) {
            ...
            <div class="form-group">
                ...
                <label>
                    Ayudante ${i + 1} <span class="text-danger">*</span>
                </label>
